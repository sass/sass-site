...
$(function() {
  $(".code-example").each(function() {
    ...
    if (hasCssTab) {
      ul.append(
        $("<li class='css-tab'></li>").prepend(
          "<a href='#example-" + id + "-css'>CSS</a>"
        )
      );
    }
...
(function docNav() {
  // Vars
  var nav = $(".sl-l-medium-holy-grail__navigation");
  ...
  function stickyNav() {
    if ($(window).scrollTop() >= sticky.top) {
      ...
      nav.css({ top: "initial", position: "relative", overflowY: "initial" });
    }
  }
